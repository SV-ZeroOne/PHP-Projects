...
class CarController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        // Using the Template annotation at the top we no longer require the render
        // $this->render('car/index.html.twig',
        return array(
            'cars' => $cars,
        );
    }
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('/admin/car/{id}', array('id' => $car->getId()));
        }
    ...
    public function editAction(Request $request, Car $car)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('/admin/car/{id}/edit', array('id' => $car->getId()));
        }
    ...
    public function deleteAction(Request $request, Car $car)
    {
        ...
        return $this->redirectToRoute('/admin/car/');
    }
